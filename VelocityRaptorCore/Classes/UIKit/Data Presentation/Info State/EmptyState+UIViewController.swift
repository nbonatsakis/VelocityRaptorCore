//
//  EmptyState+UIViewController.swift
//  VelocityRaptorCore
//
...
extension InfoStateDisplayable where Self: UIViewController {
    ...
    func show(infoState: InfoState, animated: Bool = true) {
        ...
        show(emptyStateView: EmptyStateContentView(emptyState: infoState), animated: animated)
    }

    func show(emptyStateView: EmptyStateContentView, animated: Bool = true) {
        hideEmptyState(animated: animated)

        let emptyStateWrapperView = EmptyStateView(contentView: emptyStateView)
    ...
    var existingEmptyStateView: EmptyStateView? {
...
class EmptyStateView: UIView {
    ...
    let contentView: EmptyStateContentView

    init(contentView: EmptyStateContentView) {
